...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'afkers' => App\GraphQL\Query\Afkers::class,
                ...
                'sign_ups' => \App\GraphQL\Query\SignUps::class,
     ...
     */
    'types' => [
        'Afk' => App\GraphQL\Afk::class,
        'Character' => App\GraphQL\Character::class,
        'CharacterClass' => App\GraphQL\CharacterClass::class,
        'Event' => App\GraphQL\Event::class,
        'SignUp' => App\GraphQL\SignUp::class,
        'User' => App\GraphQL\User::class,
    ],
